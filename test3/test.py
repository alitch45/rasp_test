...
'traffic_light','fire hydrant','???','stop_sign','parking_meter','bench','bird','cat','dog','horse',
'sheep','cow','elephant','bear','zebra','giraffe','???','backpack','umbrella','???',
'???','handbag','tie','suitcase','frisbee','skis','snowboard','sports ball','kite','baseball bat',
'baseball glove','skateboard','surfboard','tennis_racket','bottle','???','wine_glass','cup','fork','knife',
...
'toaster','sink','refrigerator','???','book','clock','vase','scissors','teddy_bear','hair_drier',
'toothbrush']
    ...
    def _boxes_coordinates(self,
        ...
        for i in range(number_boxes):
            if scores is None or scores[i] > min_score_thresh:
                ...
                detect_time =datetime.datetime.fromtimestamp(time.time())
                edge_time =detect_time - start_time
